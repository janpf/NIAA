...
class SSPexelsSmall(torch.utils.data.Dataset):
    def __init__(self, file_list_path: str, mapping, return_file_name: bool = False, normalize: bool = True, orig_dir: str = "/scratch/pexels/images_small", edited_dir: str = "/scratch/pexels/edited_images_small"):
