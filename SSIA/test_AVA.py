...
out_file = f"/workspace/analysis/not_uploaded/SSIA_{base_model}_test_scores_AVA.csv"
...
# datasets
Pexels_test = torch.utils.data.DataLoader(AVA(), batch_size=100, drop_last=False, num_workers=50)
