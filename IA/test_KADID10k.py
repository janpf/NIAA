...
from IA.dataset import KADID10k
...
out_file = "/workspace/analysis/not_uploaded/IA/KADID10k/" + config.model_path.replace("/", ".") + ".txt"
...
# datasets
Pexels_test = torch.utils.data.DataLoader(KADID10k(), batch_size=5, drop_last=False, num_workers=40)
