...
from IA.dataset import Unsplash
...
out_file = "/workspace/analysis/not_uploaded/IA/unsplash/" + config.model_path.replace("/", ".") + ".txt"
...
# datasets
Pexels_test = torch.utils.data.DataLoader(Unsplash(), batch_size=5, drop_last=False, num_workers=40)
