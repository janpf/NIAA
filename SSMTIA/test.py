...
model_path = "/scratch/ckpts/SSMTIA-CP/pexels/mobilenet/epoch-2.pth"
...
# datasets
SSPexels_test = SSPexels(file_list_path="/workspace/dataset_processing/test_set.txt", mapping=mapping, return_file_name=True)
